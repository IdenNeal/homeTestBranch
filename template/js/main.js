...
if (document.location.pathname === "/index.html" || document.location.pathname === '/' || document.location.pathname === '') {
  // slider init
...
document.querySelector('.ask .form__row .row__btn').addEventListener('click', function (e) {
  let res = document.querySelector(`.ask__result`);
...
document.querySelector('.order .form__row .row__btn').addEventListener('click', function (e) {
  let res = document.querySelector(`.order__result`);
...
if (document.location.pathname === "/timetable.html" || document.location.pathname === '')
  TabsActivation('.tab > .tablinks', '.tabs__wrap--timetable', '.tabcontent');

if (document.location.pathname === "/prices.html" || document.location.pathname === '')
